      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative h-[70vh] flex items-center">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            >
              Order delicious food from your college canteen with just a few clicks
            </motion.p>
...
const features = [
  {
    ...
    description: 'Order your favorite meals with just a few taps and get them delivered to your location.',
  ...
  },
  {
    ...
    description: 'Get exclusive deals and discounts on your favorite meals every day.',
    icon: () => (
  ...
  {
    title: 'Track Orders',
    description: 'Real-time tracking of your order status from preparation to delivery.',
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
